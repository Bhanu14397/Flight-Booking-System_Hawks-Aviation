...
builder.Services.AddDbContext<HawksAvaitionDBContext>(options =>
{
    options.UseSqlServer(
        connectionString: "Data Source=LAPTOP-5O6H91TF;Initial Catalog=HawksAviationDb;Integrated Security=True" //builder.Configuration["ConnectionString:HawksAviationDB"]
    ); 
});
#endregion
